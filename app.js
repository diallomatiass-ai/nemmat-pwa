  ...
  'andengradspolynomier-hf': {
    ...
    '1-3': [
      { q: 'Angiv koefficienterne for $f(x)=3x^2-6x+10$',
        opts: ['$a=3,b=10,c=-6$','$a=3,b=6,c=10$','$a=10,b=6,c=3$','$a=3,b=-6,c=10$'], ans: 3 },
      { q: 'Angiv koefficienterne for $f(x)=x^2+5$',
        opts: ['$a=1,b=5,c=0$','$a=1,b=0,c=5$','$a=0,b=0,c=5$','$a=1,b=1,c=5$'], ans: 1 },
      { q: 'Hvad er koefficienten foran andengradsleddet?',
        opts: ['$b$','$a$'], ans: 1 },
      { q: 'Angiv koefficienterne for $f(x)=-x^2+2x$',
        opts: ['$a=-1,b=2,c=0$','$a=1,b=0,c=2$','$a=-1,b=0,c=2$','$a=1,b=2,c=0$'], ans: 0 },
      { q: 'Angiv koefficienterne for $f(x)=-5x^2-4x-3$',
        opts: ['$a=5,b=-3,c=-4$','$a=5,b=4,c=3$','$a=5,b=4,c=-3$','$a=-5,b=-4,c=-3$'], ans: 3 },
      { q: 'Hvad er koefficienten foran førstegradsleddet?',
        opts: ['$b$','$c$'], ans: 0 },
      { q: 'Angiv koefficienterne for $f(x)=0{,}5x^2$',
        opts: ['$a=2,b=0,c=0$','$a=0,b=0,c=5$','$a=0{,}5,b=0,c=0$','$a=5,b=0,c=0$'], ans: 2 },
      { q: 'Hvad kaldes grafen for et andengradspolynomium?',
        opts: ['Parabel','Cirkel'], ans: 0 },
      { q: 'Hvilken koefficient svarer til konstantleddet i et andengradspolynomium?',
        opts: ['$a$','$c$'], ans: 1 }
    ],
    '2-2': [
      { q: 'Beregn toppunktskoordinat for $f(x)=x^2-6x+8$',
        opts: ['$(1,-3)$','$(1,3)$','$(3,-1)$','$(2,-1)$'], ans: 2 },
      { q: 'Aflæs toppunktskoordinaterne fra grafen for en parabel',
        opts: ['$(2,-16)$','$(2,16)$','$(-2,16)$','$(-2,-16)$'], ans: 3 },
      { q: 'Aflæs førstekoordinaten til toppunktet ved symmetriargument',
        opts: ['$x=-2$','$x=2$','$x=-16$','$x=16$'], ans: 0 },
      { q: 'Beregn toppunktskoordinat for $f(x)=-3x^2+12x-7$',
        opts: ['$(2,-3)$','$(1,4)$','$(2,5)$','$(2,2)$'], ans: 2 },
      { q: '$h(t)=-t^2+6t+4$: hvornår er boldens højde maksimal, og hvad er den?',
        opts: ['1 sek, 8 m','5 sek, 25 m','2 sek, 10 m','3 sek, 13 m'], ans: 3 }
    ],
    '3-3': [
      { q: 'Løs $x^2-x-12=0$',
        opts: ['$x=-2$ eller $x=-3$','$x=3$ eller $x=4$','$x=-3$ eller $x=4$','$x=-1$ eller $x=5$'], ans: 2 },
      { q: 'Løs $2x^2-3x-2=0$',
        opts: ['$x=-2$ eller $x=-3$','$x=-3$ eller $x=3$','$x=0$ eller $x=2$','$x=-\\frac{1}{2}$ eller $x=2$'], ans: 3 },
      { q: 'Løs $x^2-5x=0$',
        opts: ['$x=-5$ eller $x=1$','$x=0$ eller $x=5$','$x=5$ eller $x=-1$','$x=0$ eller $x=-5$'], ans: 1 },
      { q: 'Løs $2x^2+6x=0$',
        opts: ['$x=0$ eller $x=-3$','$x=-2$ eller $x=0$','$x=0$ eller $x=3$','$x=-1$ eller $x=3$'], ans: 0 },
      { q: 'Løs $x^2-16=0$',
        opts: ['$x=-16$ eller $x=0$','$x=-16$ eller $x=16$','$x=4$ eller $x=-4$','$x=8$ eller $x=-8$'], ans: 2 },
      { q: 'Løs $3x^2-27=0$',
        opts: ['$x=-9$ eller $x=9$','$x=3$ eller $x=-3$','$x=27$ eller $x=-27$','$x=0$ eller $x=1$'], ans: 1 },
      { q: 'Løs $4x^2-12x+8=0$',
        opts: ['$x=-2$ eller $x=-3$','$x=1$ eller $x=2$','$x=-1$ eller $x=4$','$x=2$ eller $x=4$'], ans: 1 },
      { q: 'Løs $x^2+5x+6=0$',
        opts: ['$x=-2$ eller $x=-3$','$x=3$ eller $x=4$','$x=-1$ eller $x=-2$','$x=-1$ eller $x=4$'], ans: 0 },
      { q: 'Løs $x^2-4x-5=x-5$',
        opts: ['$x=0$ eller $x=4$','$x=0$ eller $x=5$','$x=-5$ eller $x=5$','$x=0$ eller $x=3$'], ans: 1 }
    ],
    '4-2': [
      { q: 'Benyt nulreglen: $5\\cdot(x-4)\\cdot(x+2)=0$',
        opts: ['$x=4$ eller $x=2$','$x=-4$ eller $x=-2$','$x=4$ eller $x=-2$','$x=-4$ eller $x=2$'], ans: 2 },
      { q: 'Faktoriser $f(x)=x^2-5x+6$',
        opts: ['$f(x)=(x-2)(x-3)$','$f(x)=(x-0)(x-4)$','$f(x)=(x-1)(x+2)$','$f(x)=(x+2)(x+3)$'], ans: 0 },
      { q: 'Faktoriser $f(x)=3x^2+9x-12$',
        opts: ['$3(x-2)(x-3)$','$3(x-0)(x-2)$','$3(x+3)(x-2)$','$3(x+4)(x-1)$'], ans: 3 },
      { q: '$a=5$, rødderne $x_1=-2$ og $x_2=7$. Faktoriser polynomiet',
        opts: ['$7(x+2)(x-5)$','$5(x+2)(x-7)$','$(x+2)(x-7)$','$-2(x+5)(x-7)$'], ans: 1 },
      { q: 'Benyt nulreglen: $-3\\cdot(2x-6)\\cdot(x+4)=0$',
        opts: ['$x=-3$ eller $x=4$','$x=-3$ eller $x=-4$','$x=3$ eller $x=-4$','Ligningen kan ej løses'], ans: 2 }
    ],
    '5-2': [
      { q: 'Brobue: toppunkt $(0,9)$, rammer x-aksen i $(-6,0)$ og $(6,0)$. Bestem $a,b,c$',
        opts: ['$a=-0{,}25,b=-9,c=9$','$a=-0{,}25,b=9,c=0$','$a=0{,}25,b=9,c=0$','$a=-0{,}25,b=0,c=9$'], ans: 3 },
      { q: 'Regression på omsætningstabel ($x=0..10$): bestem $a,b,c$',
        opts: ['$a=-1{,}88,b=8{,}35,c=10{,}78$','$a=-0{,}88,b=10{,}35,c=1{,}78$','$a=-2{,}88,b=8{,}35,c=3{,}78$','$a=-0{,}88,b=8{,}35,c=0{,}78$'], ans: 3 },
      { q: 'Bestem toppunktet og forklar dets betydning i omsætningsmodellen',
        opts: ['Ca. 6 varer, 30.500 kr','Ca. 5 varer, 20.500 kr','Ca. 3 varer, 10.000 kr','Ca. 4 varer, 10.500 kr'], ans: 1 }
    ],
    '6-0': [
      { q: '$2x^2-6x-8=0$: bestem $d$ og løs ligningen',
        opts: ['$d=100$, $x=-2$ eller $x=3$','$d=84$, $x=1$ eller $x=3$','$d=84$, $x=0$ eller $x=4$','$d=100$, $x=-1$ eller $x=4$'], ans: 3 },
      { q: 'Tabel for $g$: $g(0)=4$, $g(3)=12$, $g(7)=0$. Skæring med $y$-aksen?',
        opts: ['$(-1,0)$','$(0,4)$','$(0,7)$','$(7,0)$'], ans: 1 },
      { q: 'Tabel for $g$: $g(-1)=0$ og $g(7)=0$. Bestem rødderne',
        opts: ['$x=2$ eller $x=4$','$x=1$ eller $x=5$','$x=0$ eller $x=4$','$x=-1$ eller $x=7$'], ans: 3 },
      { q: 'Tabel for $g$: $g(3)=12$ og grafen er symmetrisk om $x=3$. Toppunkt?',
        opts: ['$(3,12)$','$(4,7)$','$(3,9)$','$(7,0)$'], ans: 0 },
      { q: 'Parabel åbner opad og har aksesymmetrilinje $x=-\\frac{3}{4}$ (til venstre for $y$-aksen). Hvilken forskrift?',
        opts: ['$h(x)=2x^2-3x+5$','$f(x)=2x^2+3x+5$','$g(x)=-2x^2+3x+5$','Ingen af dem'], ans: 1 },
      { q: '$a<0$, $c>0$, $b>0$: Parablen åbner...',
        opts: ['Nedad (grene nedad)','Opad (grene opad)'], ans: 0 },
      { q: '$f(x)=-x^2+6x-5$: toppunktskoordinat?',
        opts: ['$(4,7)$','$(1,4)$','$(3,4)$','$(-3,-4)$'], ans: 2 },
      ...
      { q: '$a<0$, $c>0$: parablen skærer $y$-aksen i...',
        opts: ['Et negativt tal','Et positivt tal','Origo','Kan ikke afgøres'], ans: 1 },
      { q: '$f(x)=2x^2-bx-c$ har toppunktet $(1,5)$. Bestem $b$ og $c$',
        opts: ['$b=-4$ og $c=7$','$b=-3$ og $c=5$','$b=2$ og $c=5$','$b=4$ og $c=-7$'], ans: 0 },
      { q: '$f(x)=2x^2-8x+c$: bestem $c$ så grafen har præcis ét nulpunkt',
        opts: ['$c=9$','$c=-3$','$c=8$','$c=4$'], ans: 2 },
      { q: 'En parabel åbner op og har to nulpunkter. Hvad gælder for $a$ og $d$?',
        opts: ['$a>0$ og $d<0$','$a<0$ og $d<0$','$a>0$ og $d>0$','$a<0$ og $d=0$'], ans: 2 },
      { q: 'Parabel med toppunkt $x_T=2$ og rod $x=-1$. Bestem den anden rod',
        opts: ['$x=3$','$x=4$','$x=5$','$x=6$'], ans: 2 },
      { q: 'Er $x=1$ en rod i $f(x)=x^2-3x+2$?',
        opts: ['Nej, $f(1)=2\\neq 0$','Ja, $f(1)=0$'], ans: 1 },
      { q: '$a>0$ og $d>0$: parablen...',
        opts: ['Åbner op og rammer ikke $x$-aksen','Åbner op og rammer $x$-aksen to gange','Åbner ned og rammer $x$-aksen to gange','Åbner ned og rammer ikke $x$-aksen'], ans: 1 },
      { q: '$f(x)=-x^2+6x-5$: bestem diskriminanten og antal rødder',
        opts: ['$d=-56$, ingen rødder','$d=56$, to rødder','$d=56$, ingen rødder','$d=56$, én rod'], ans: 1 },
